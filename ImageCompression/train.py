...
train_set = dataset.ImageFolder(root=cfg.train, transform=train_transform)

train_loader = data.DataLoader(
    dataset=train_set, batch_size=cfg.batch_size, shuffle=True, num_workers=1)
...
if cfg.checkpoint:
    ...
    last_epoch = cfg.checkpoint
    scheduler.last_epoch = last_epoch - 1

for epoch in range(last_epoch + 1, cfg.max_epochs + 1):
    ...
    for batch, data in enumerate(train_loader):
        ...
        loss = sum(losses) / cfg.iterations
        loss.backward()
