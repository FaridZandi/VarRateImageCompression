...
parser.add_argument("--output", default="result_parr_4.csv", type=str)
...
all_files = ["result_parr_1.csv", "result_parr_2.csv", "result_parr_3.csv"]    # advisable to use os.path.join as this makes concatenation OS independent
...
for img_path, img_class in images:
    try: 
        ...
        for encoder_mapping in range (5,8): 
